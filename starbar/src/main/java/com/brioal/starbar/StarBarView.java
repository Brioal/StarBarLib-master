...
public class StarBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.StarBarView_starDistance, 0);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.StarBarView_starSize, 20);
        this.isTouchable = mTypedArray.getBoolean(R.styleable.StarBarView_isTouchable, false);
        this.starCount = mTypedArray.getInteger(R.styleable.StarBarView_starCount, 5);
